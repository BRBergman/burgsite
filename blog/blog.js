...
var blog = [
  ...
  [
    "10/5/2024",
    " i can only do so much reading before the words start to mesh together, maybe i need glasses ",
  ],
  ["10/29/2024", "<i>hacker voice</i> im in </br>(accepted to a college) "],
  [
    "10/31/2024",
    " halloween happened too fast i didn't have time to get a costume :( ",
  ],
  ...
  [
    "2/4/2025",
    "im gonna stop trying to be oh so special and just use js for all of this...",
  ],
  [
    "2/14/2025",
    "hrt soon (irls this is for super cis reasons i promise, never would i ever try to hide anything from any of you)",
  ],
  [
    "2/14/2025",
    "valentines day is cool and all but have you tried koth_harvest",
  ],
  ...
  [
    "4/2/2026",
    "AUUUUGHHH stress is real so much work so little motivation.........",
  ],
].reverse();
...
function fullpage_blog() {
  ...
  blog.forEach((arg) => {
    let single_blog = "<div><h1>" + arg[0] + "</h1><p>" + arg[1] + "</p></div>";
...
function recent_blog() {
  ...
  let single_blog =
    "<h3> Latest Blog: " + first_blog[0] + "</h3><p>" + first_blog[1] + "</p>";
  x.innerHTML = single_blog;
}
recent_blog();
